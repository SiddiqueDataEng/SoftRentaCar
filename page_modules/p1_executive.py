...
with col_g1:
    st.plotly_chart(gauge(util_pct, "Fleet Utilisation"), use_container_width=True)
with col_g2:
    st.plotly_chart(gauge(round(avg_safety,1), "Safety Score"), use_container_width=True)
